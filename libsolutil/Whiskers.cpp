...
void Whiskers::checkTemplateContainsTags(string const& _parameter, vector<string> const& _prefix) const
{
	for (auto const& aTag: _prefix)
	{
		string tag{"<" + aTag + _parameter + ">"};
		assertThrow(
